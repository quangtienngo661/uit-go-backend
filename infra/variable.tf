...
variable "enable_alb" {
  type        = bool
  default     = false
  description = "Enable ALB resources (set to true if account has ALB access)"
}
...
variable "enable_budget" {
  type        = bool
  default     = false
  description = "Set true to create AWS Budget (requires at least one subscriber email)"
}

variable "enable_anomaly_monitor" {
  type        = bool
  default     = false
  description = "Set true to create CE anomaly monitor (ensure account has available quota)"
}
